...
const ManageSocialMediaLinks = () => {
  ...
  const platforms = [
    ...
    { value: 'goodreads', label: 'Goodreads', icon: '📚' },
    { value: 'amazon', label: 'Amazon Author Page', icon: '🛒' },
    { value: 'blog', label: 'Personal Blog', icon: '✍️' },
    ...
    <div className="min-h-screen bg-gray-50 pt-20">
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center space-x-2 mb-4">
                        ...
                        <h4 className="text-lg font-semibold text-gray-900">Author Information</h4>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center space-x-6">
                            ...
                            {imagePreview ? (
                                ...
                                <div className="h-24 w-24 rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center border-4 border-white shadow-lg">
                            ...
                            <label
                                htmlFor="authorImage"
                                className="cursor-pointer inline-flex items-center px-4 py-3 border-2 border-dashed border-gray-300 rounded-xl text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 hover:border-blue-400 transition-all duration-200 w-full justify-center group"
                            >
                    ...
                    <div className="flex items-center space-x-2 mb-4">
                        ...
                        <h4 className="text-lg font-semibold text-gray-900">Social Media Information</h4>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <label htmlFor="isActive" className="ml-3 flex-1">
                            ...
                            <p className="text-xs text-gray-500">When active, this link will be visible to users</p>
                        </label>
                    ...
                    <button
                        type="button"
                        onClick={closeModal}
                        className="px-6 py-3 border-2 border-gray-300 rounded-xl text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-all duration-200 transform hover:-translate-y-0.5"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="md:flex md:items-center md:justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Manage Social Media Links</h1>
          ...
          <div className="px-6 py-4 border-b border-gray-200">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="text-sm text-gray-600">
                {filteredLinks.length} of {socialLinks.length} links
              </div>
            </div>
          </div>
                  ...
                  <tr>
                    <td colSpan="5" className="px-6 py-12 text-center">
                      <div className="text-gray-500">
                        ...
                        <p className="mt-4">No social media links found</p>
                        <button
                          onClick={openAddModal}
                    ...
                    <tr key={link.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            <div className="text-sm font-medium text-gray-900">{link.authorName}</div>
                            <div className="text-sm text-gray-500">{link.authorEmail || 'No email'}</div>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="flex items-center">
                          <span className="text-2xl mr-3">{getPlatformIcon(link.platform)}</span>
                          <div>
                            <div className="text-sm font-medium text-gray-900 capitalize">{link.platform}</div>
                            {link.username && (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">{socialLinks.length}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">Unique Platforms</p>
                <p className="text-2xl font-semibold text-gray-900">
